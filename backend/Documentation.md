...
### 3. Join Full Medical Data(Detailed) - For Doctor
...
app/services/appointment_service.py   ✅ (add logic)
app/api/appointment_routes.py         ✅ (add route)
